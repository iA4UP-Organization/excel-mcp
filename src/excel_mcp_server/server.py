"""FastMCP server for Excel operations - iA4UP Secure Version.

Version sécurisée sans Smithery.
Toutes les opérations sont locales, aucune donnée n'est envoyée à l'extérieur.
"""
...
mcp = FastMCP("Excel MCP Server (iA4UP Secure)")
